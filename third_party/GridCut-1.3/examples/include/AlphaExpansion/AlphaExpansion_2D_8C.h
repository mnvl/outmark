...
#ifndef AlphaExpansion_2D_8C_H_
#define AlphaExpansion_2D_8C_H_
...
//2:  [ 1,-1]
//3:  [ 1, 1]
#define ALPHAEXPANSION_NEIGHBORS 4
...
public:
	...
	AlphaExpansion_2D_8C(int width, int height, int nLabels, type_cost *data, type_cost **smooth);
	AlphaExpansion_2D_8C(int width, int height, int nLabels, type_cost *data, SmoothCostFn smooth_fn);
	~AlphaExpansion_2D_8C(void);
...
private:
	...
	type_label *labeling;
	bool smooth_array;
	typedef GridGraph_2D_8C<type_cost,type_cost,type_cost> Grid;
	Grid* grid;
...
type_cost AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::get_data_cost(int pix,int lab) const
{
	return data_cost[(pix)*nLabels + lab];
}

template<typename type_label, typename type_cost, typename type_energy>
type_cost AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::get_smooth_cost(int pix,int lab1,int lab2) const
{
	return smooth_cost[pix][(lab2)+(lab1)*nLabels]; 
}

template<typename type_label, typename type_cost, typename type_energy>
void AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::init_common(int width, int height, int nLabels, type_cost *data)
{
	this->width = width;
	this->height = height;
...
template<typename type_label, typename type_cost, typename type_energy>
AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::AlphaExpansion_2D_8C(int width, int height, int nLabels, type_cost *data, type_cost **smooth)
{
...
template<typename type_label, typename type_cost, typename type_energy>
AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::AlphaExpansion_2D_8C(int width, int height, int nLabels, type_cost *data, SmoothCostFn smoothFn)
{
	init_common(width, height, nLabels, data);
...
template<typename type_label, typename type_cost, typename type_energy>
void AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::set_labeling(type_label* new_labeling)
{
...
template<typename type_label, typename type_cost, typename type_energy>
void AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::set_labels(type_label label)
{
...
template<typename type_label, typename type_cost, typename type_energy>
type_energy AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::get_data_energy(){
...
template<typename type_label, typename type_cost, typename type_energy>
type_energy AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::get_smooth_energy(){
	...
	for ( int y = 1; y < height; y++ ){
		for ( int x = 0; x < width - 1; x++ ){
			pix = x+y*width;
			energy += get_smooth_cost(ALPHAEXPANSION_NEIGHBORS*pix+2, labeling[pix], labeling[pix-width+1]);
		}
	}
	...
	for ( int y = 0; y < height - 1; y++ ){
		for ( int x = 0; x < width - 1; x++ ){
			pix = x+y*width;
			energy += get_smooth_cost(ALPHAEXPANSION_NEIGHBORS*pix+3, labeling[pix], labeling[pix+width+1]);
		}
	}
...
template<typename type_label, typename type_cost, typename type_energy>
type_energy AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::get_smooth_energy_fn(){
...
template<typename type_label, typename type_cost, typename type_energy>
type_energy AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::get_energy()
{
...
template<typename type_label, typename type_cost, typename type_energy>
void AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::perform()
{
...
template<typename type_label, typename type_cost, typename type_energy>
void AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::perform(int max_cycles)
{
...
template<typename type_label, typename type_cost, typename type_energy>
void AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::perform_random(int max_cycles)
{
...
template<typename type_label, typename type_cost, typename type_energy>
void AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::perform_random()
{
...
template<typename type_label, typename type_cost, typename type_energy>
void AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::perform(int max_cycles, bool random)
{
...
template<typename type_label, typename type_cost, typename type_energy>
type_energy AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::perform_cycle(bool random)
{
...
template<typename type_label, typename type_cost, typename type_energy>
void AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::perform_label(type_label alpha_label){
...
template<typename type_label, typename type_cost, typename type_energy>
void AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::create_grid_array(type_label alpha_label){
		...
		for (int x = 0; x < width; x++){
			...
			if(labeling[pix] != alpha_label){
				...
				if (x < width - 1 && y > 0){				
					nPix = pix - width + 1;
					if(labeling[nPix] != alpha_label){
						add_nlink(x, y, 1, -1, get_smooth_cost(indices[2], alpha_label, alpha_label), get_smooth_cost(indices[2], alpha_label, labeling[nPix]), 
				...
				if (x < width - 1 && y < height - 1){				
					nPix = pix + width + 1;
					if(labeling[nPix] != alpha_label){
						add_nlink(x, y, 1, 1, get_smooth_cost(indices[3], alpha_label, alpha_label), get_smooth_cost(indices[3], alpha_label, labeling[nPix]),
...
template<typename type_label, typename type_cost, typename type_energy>
void AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::create_grid_fn(type_label alpha_label)
{
		...
		for (int x = 0; x < width; x++){
			...
			if(labeling[pix] != alpha_label){
				...
				if (x < width - 1 && y > 0){				
					nPix = pix - width + 1;
					if(labeling[nPix] != alpha_label){
						add_nlink(x, y, 1, -1, smooth_fn(pix, nPix, alpha_label, alpha_label), smooth_fn(pix, nPix, alpha_label, labeling[nPix]), 
							smooth_fn(pix, nPix, labeling[pix], alpha_label), smooth_fn(pix, nPix, labeling[pix], labeling[nPix]), source, sink);
					}else{
						add_tlink(pix, smooth_fn(pix, nPix, labeling[pix], alpha_label), smooth_fn(pix, nPix, alpha_label, labeling[nPix]), source, sink);
					}
...
template<typename type_label, typename type_cost, typename type_energy>
void AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::add_nlink(int x, int y, int nx, int ny, type_cost A, type_cost B, type_cost C, type_cost D, type_cost *source, type_cost *sink){
...
template<typename type_label, typename type_cost, typename type_energy>
void AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::add_tlink(int pix, type_cost to_source, type_cost to_sink, type_cost *source, type_cost *sink)
{
...
template<typename type_label, typename type_cost, typename type_energy>
type_label * AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::get_labeling(void)
{
...
template<typename type_label, typename type_cost, typename type_energy>
type_label AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::get_label(int x, int y)
{
...
template<typename type_label, typename type_cost, typename type_energy>
type_label AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::get_label(int pix)
{
...
template<typename type_label, typename type_cost, typename type_energy>
AlphaExpansion_2D_8C<type_label, type_cost, type_energy>::~AlphaExpansion_2D_8C(void){
